...
import { productDeleteByIdHandler } from "../endpoints/productDeleteById";
...
import { categoriesPostHandler } from "../endpoints/categories/createCategory";
import { getCategoriesHandler } from "../endpoints/categories/getCategories";
...
protectedRoutes.delete("/products/:id", productDeleteByIdHandler);
protectedRoutes.post("/categories", categoriesPostHandler);
protectedRoutes.get("/categories", getCategoriesHandler);
